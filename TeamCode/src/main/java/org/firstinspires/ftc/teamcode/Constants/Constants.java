...
public class Constants {
    ...
    public static PinpointConstants pinpointConstants = new PinpointConstants()
            ...
            .forwardEncoderDirection(GoBildaPinpointDriver.EncoderDirection.FORWARD) //IMPORTANT MAKE SURE TO SE CORRECT DIRECTION FORWARD MEANS FORWARD
            .strafeEncoderDirection(GoBildaPinpointDriver.EncoderDirection.FORWARD);//IMPORTANT MAKE SURE TO SE CORRECT DIRECTION LEFT MEANS FORWARD
